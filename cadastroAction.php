...
$conecta->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION); }catch(PDOException $e){
echo "falha ao conectar: ". $e->getMessage(); }
$sql = "INSERT INTO aluno (nome, email, login, senha, celular)
VALUES ('".$_POST['txtNome']."', '".$_POST['txtEmail']."', '".$_POST['txtLogin']."', '".$_POST['txtSenha']."', '".$_POST['txtCelular']."')";
try{
$resultado = $conecta->query($sql); echo '
<a href="sitepersonal.php">
<h1 class="w3-button w3-blue">Aluno Salvo com sucesso! </h1>

</a>
'; }catch(PDOException $e){
            echo '
                <a href="sitepersonal.php">
<h1 class="w3-button w3-blue">ERRO! </h1> </a>
'; }
?> </div>
</body>
</html>