...
<?php
        ...
        $bd = "suporte";
        try{
$conecta = new PDO("mysql:dbname=$bd; host=$host; port=3306; chars et=utf8", $usuario, $senha);
$conecta->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION); }catch(PDOException $e){
echo "falha ao conectar: ". $e->getMessage(); }
        try{
            $sql = $conecta->prepare("DELETE FROM aluno WHERE cpf_aluno = ?;"); 
            $sql->bindParam(1,$_POST['txtCPF']);
            $sql->execute();
echo '
<a href="listar.php">
<h1 class="w3-button w3-blue">Aluno Excluido com sucesso! </h1>
</a>
